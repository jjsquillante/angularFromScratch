...
describe('Scope', function() {
	...
	describe('$watchCollection', function () {
		...
		it('does not consider any object with a length property an array/array-like.', function () {
			scope.obj = {
				length: 42,
				otherKey: 'abc'
			};
		...
		it('gives the old non-collection value to the listeners.', function () {
			scope.aValue = 42;
			var oldValueGiven;
	...
	_.forEach(['$broadcast', '$emit'], function(method) {
		it('does not stop on exceptions on ' + method, function () {
			var listener1 = function(event) {
				throw 'listener throwing an exception.';
			};
